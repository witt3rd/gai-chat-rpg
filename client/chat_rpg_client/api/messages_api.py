...
class MessagesApi(object):
    ...
    @validate_arguments
    def delete_message(self, id : Any, **kwargs) -> Message:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the delete_message_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.delete_message_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    def delete_message_with_http_info(self, id : Any, **kwargs) -> ApiResponse:  # noqa: E501
        """Delete Message  # noqa: E501
        ...
        >>> thread = api.delete_message_with_http_info(id, async_req=True)
        >>> result = thread.get()
    ...
    def send_message_with_http_info(self, message_create : MessageCreate, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        # process the body parameter
        _body_params = None
        if _params['message_create'] is not None:
            _body_params = _params['message_create']
    ...
    @validate_arguments
    def update_message(self, id : Any, message_update : MessageUpdate, **kwargs) -> Message:  # noqa: E501
        ...
        >>> thread = api.update_message(id, message_update, async_req=True)
        >>> result = thread.get()

        :param id: (required)
        :type id: object
        :param message_update: (required)
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the update_message_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.update_message_with_http_info(id, message_update, **kwargs)  # noqa: E501

    @validate_arguments
    def update_message_with_http_info(self, id : Any, message_update : MessageUpdate, **kwargs) -> ApiResponse:  # noqa: E501
        """Update Message  # noqa: E501
        ...
        >>> thread = api.update_message_with_http_info(id, message_update, async_req=True)
        >>> result = thread.get()
        ...
        # process the body parameter
        _body_params = None
        if _params['message_update'] is not None:
            _body_params = _params['message_update']
